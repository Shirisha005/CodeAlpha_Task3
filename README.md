...
**Conclusion**
By automating these repetitive tasks with Python scripts, I have significantly improved my workflow efficiency. This repository serves as a foundation for further automation projects and can be expanded with additional scripts as new tasks are identified. Feel free to contribute or adapt these scripts for your own use!
